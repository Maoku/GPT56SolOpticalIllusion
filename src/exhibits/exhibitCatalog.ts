...
export const exhibitCatalog: ExhibitDefinition[] = [
  ...
  },
  {
    ...
    position: [18.2, 1.55, 0], rotation: [0, -Math.PI / 2, 0], interactionDistance: 4.8,
    ...
    viewSpots: [{ id: 'shadow-console', label: '照明卓', position: [12.8, 1.65, 0], target: [16.28, 0.12, 0], tolerance: 1.1 }],
    interactionAnchors: [{ id: 'shadow-console', position: [12.8, 1.65, 0], radius: 1.35, target: [16.28, 0.12, 0], activation: 'automatic' }],
  ...
  },
  {
    ...
    viewSpots: [{ id: 'ames-aperture', label: '固定鑑賞点', position: [11.7, 1.65, -9], target: [17.2, 1.4, -9], tolerance: 0.75 }],
    interactionAnchors: [
      { id: 'ames-aperture', position: [11.7, 1.65, -9], radius: 1.2, target: [17.2, 1.4, -9], activation: 'automatic' },
      { id: 'ames-reveal', position: [14.2, 1.65, -4.7], radius: 1.55, target: [16.7, 1.4, -9], activation: 'automatic' },
    ],
  ...
  },
  {
    ...
    position: [-10, 2.25, -17], rotation: [0, 0, 0], interactionDistance: 5.2,
    ...
    viewSpots: [{ id: 'bloom-origin', label: '花の成立点', position: [-10, 1.65, -10.8], target: [-10, 2.25, -17], tolerance: 0.85 }],
    interactionAnchors: [{ id: 'bloom-origin', position: [-10, 1.65, -10.8], radius: 1.35, target: [-10, 2.25, -17], activation: 'automatic' }],
    recommendedAfter: ['chromatic-echo-corridor'], legacy: true,
  ...
  },
  {
    ...
    position: [-2.5, 1.55, -17], rotation: [0, 0, 0], interactionDistance: 4.8,
    ...
    viewSpots: [{ id: 'echo-entry', label: '順応室入口', position: [-2.5, 1.65, -11.5], target: [-2.5, 1.65, -17], tolerance: 1.2 }],
    interactionAnchors: [
      { id: 'echo-entry', position: [-2.5, 1.65, -11.5], radius: 1.55, target: [-2.5, 1.65, -17], activation: 'automatic' },
      { id: 'echo-adapt', position: [-2.5, 1.65, -14.2], radius: 1.75, target: [-2.5, 1.65, -17], activation: 'automatic' },
      { id: 'echo-result', position: [-2.5, 1.65, -17.2], radius: 1.75, target: [-2.5, 1.65, -19], activation: 'automatic' },
    ],
  ...
  },
  {
    ...
    position: [4.5, 1.55, -17], rotation: [0, 0, 0], interactionDistance: 5.2,
    zone: 'space', accent: '#72f0d0',
    presentation: 'installation', venue: 'signature', outcomeKind: 'alignment', perceptionAxis: 'perspective',
    shareHook: '壊れた壁が、一点だけ30mの回廊になった。', oneSentence: '分断された門と壁が、一つの視点だけで長い直線回廊になる。',
    viewSpots: [{ id: 'folded-origin', label: '回廊の成立点', position: [4.5, 1.65, -10.4], target: [4.5, 1.5, -17], tolerance: 0.7 }],
    interactionAnchors: [
      { id: 'folded-origin', position: [4.5, 1.65, -10.4], radius: 1.25, target: [4.5, 1.5, -17], activation: 'automatic' },
      { id: 'folded-reveal', position: [7.7, 1.65, -14.1], radius: 1.55, target: [4.5, 1.5, -17], activation: 'automatic' },
    ],
