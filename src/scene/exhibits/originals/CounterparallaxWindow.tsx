...
function DepthRoom({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <group scale={scale}>
      <Structure position={[11.1, 1.4, -18.9]} scale={[0.72, 2.25, 0.35]} color="#eee9df" />
      <Structure position={[13.05, 0.8, -20.2]} scale={[1.15, 1.25, 0.35]} color="#d8d3ca" />
      <Structure position={[12, 1.65, -22]} scale={[4.1, 3.1, 0.22]} color="#183044" emissive="#174c69" />
      <Structure position={[10.65, 1.55, -20.1]} scale={[0.18, 3.05, 0.18]} color="#dce6ea" />
      <Structure position={[13.35, 1.55, -20.1]} scale={[0.18, 3.05, 0.18]} color="#dce6ea" />
  ...
  return (
    <group>
      ...
      {Array.from({ length: 7 }, (_, index) => (
        <Structure
          key={`depth-${index}`}
          position={[10.05 + index * 0.65, 0.178, -19.7]}
          scale={[0.025, 0.025, 5]}
          color="#5b7685"
          emissive="#274352"
        />
